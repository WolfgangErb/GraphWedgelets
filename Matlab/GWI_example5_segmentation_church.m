...
% Example 5: how to segment a color image with graph wedgelets
...
M      = 2000;           % maximal partition size (number of leaves in BWP tree)
R.type = 'RA';
...
%% Merging part of the algorithm to get segmentation of image
nseg  = 15;      % final partition size
